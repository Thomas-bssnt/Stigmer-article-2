...
{
    GameAnalyzer analyzer(numberOfGames, std::vector<int>{0});
...
#pragma omp parallel for
    ...
    return computeTotalError(pathObservables + "observables_hum/", analyzer);
}
    ...
    const std::string &pathParametersBots)
{
    ...
    averageError = getAverageError(numberOfGames, numberOfRounds, numberOfPlayers, parameters,
                                   parametersRatings, fractionPlayersProfiles, pathObservables, botTypes, pathParametersBots);
...
int main()
{
    ...
    // const std::vector<bool> parametersToChange{false, false, true, true, true, true, true, true};

    std::tuple<std::string, std::string, std::vector<std::string>> experiment;
    // experiment = std::make_tuple("R2_vs_col_def/0_col_4_def/0_col_4_def/", "all/", std::vector<std::string>{"def", "def", "def", "def"});
    // experiment = std::make_tuple("R2_vs_col_def/1_col_3_def/1_col_3_def/", "all/", std::vector<std::string>{"col", "def", "def", "def"});
    experiment = std::make_tuple("R2_vs_col_def/2_col_2_def/2_col_2_def/", "all/", std::vector<std::string>{"col", "col", "def", "def"});
    // experiment = std::make_tuple("R2_vs_col_def/3_col_1_def/3_col_1_def/", "all/", std::vector<std::string>{"col", "col", "col", "def"});
    // experiment = std::make_tuple("R2_vs_col_def/4_col_0_def/4_col_0_def/", "all/", std::vector<std::string>{"col", "col", "col", "col"});
    // experiment = std::make_tuple("R2_vs_const/4_const1/4_const1/", "all/", std::vector<std::string>{"const1", "const1", "const1", "const1"});
    // experiment = std::make_tuple("R2_vs_const/4_const3/4_const3/", "all/", std::vector<std::string>{"const3", "const3", "const3", "const3"});
    // experiment = std::make_tuple("R2_vs_const/4_const5/4_const5/", "all/", std::vector<std::string>{"const5", "const5", "const5", "const5"});
    // experiment = std::make_tuple("R2_vs_opt/4_opt/4_opt/", "all/", std::vector<std::string>{"opt1", "opt1", "opt1", "opt1"});
    ...
    const std::string pathObservables{pathDataFigures + gameType + "exp/"};
